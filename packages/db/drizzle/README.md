...
- **0068_drop_acp_auth_secret_refs.sql**: Removes the retired ACP auth credential-reference persistence while keeping auth method selection and remote transport header Secret references intact.
