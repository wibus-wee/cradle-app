Warning: truncated output (original token count: 70951)
Total output lines: 7905
...
describe('chat runtime capability', () => {
  ...
  it('rejects expired provider-native side conversations instead of starting an empty provider session', async () => {
    ...
    try {
      ...
      expect(runt…20951 tokens truncated…rocess.env.CRADLE_CREDENTIAL_SECRET = 'chat-runtime-secret'
