...
export const session = new Elysia({
  ...
  // ── linked issue ──
  // Association semantics are owned by the Issue module; the
  // `/sessions/:id/linked-issue` routes live in the issue-owned
  // `issueExecutionAssociation` plugin (see modules/issue).
