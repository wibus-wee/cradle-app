...
- `service.ts`: Cradle-owned persistence and semantics for connection CRUD, channel bindings, thread bindings, inbound event idempotency, session creation, chat-runtime Turn event projection, interaction submission, delivery attempt recording, retry, and health projection.
