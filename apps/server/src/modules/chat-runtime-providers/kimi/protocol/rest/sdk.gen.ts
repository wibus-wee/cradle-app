...
/**
 * List one turn's file changes from the turn-level file history
 */
export const getApiV1SessionsBySessionIdFileHistoryChanges = <ThrowOnError extends boolean = false>(options: Options<GetApiV1SessionsBySessionIdFileHistoryChangesData, ThrowOnError>): RequestResult<GetApiV1SessionsBySessionIdFileHistoryChangesResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetApiV1SessionsBySessionIdFileHistoryChangesResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        path: zGetApiV1SessionsBySessionIdFileHistoryChangesPath,
        query: zGetApiV1SessionsBySessionIdFileHistoryChangesQuery
    }).parseAsync(data),
...
/**
 * A file's content as captured at a turn's file-history checkpoint
 */
export const getApiV1SessionsBySessionIdFileHistoryContent = <ThrowOnError extends boolean = false>(options: Options<GetApiV1SessionsBySessionIdFileHistoryContentData, ThrowOnError>): RequestResult<GetApiV1SessionsBySessionIdFileHistoryContentResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetApiV1SessionsBySessionIdFileHistoryContentResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        path: zGetApiV1SessionsBySessionIdFileHistoryContentPath,
        query: zGetApiV1SessionsBySessionIdFileHistoryContentQuery
    }).parseAsync(data),
...
/**
 * Add an additional directory to the workspace
 */
export const postApiV1WorkspacesByWorkspaceIdAddDir = <ThrowOnError extends boolean = false>(options: Options<PostApiV1WorkspacesByWorkspaceIdAddDirData, ThrowOnError>): RequestResult<PostApiV1WorkspacesByWorkspaceIdAddDirResponses, unknown, ThrowOnError> => (options.client ?? client).post<PostApiV1WorkspacesByWorkspaceIdAddDirResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: zPostApiV1WorkspacesByWorkspaceIdAddDirBody,
        path: zPostApiV1WorkspacesByWorkspaceIdAddDirPath,
        query: z.never().optional()
    }).parseAsync(data),
