...
- **session-layout.ts**: Session/workspace layout metadata cache — keeps session title, runtime kind, and workspace identity available synchronously to the app shell while route content and feature-owned queries are settling
