export default {
  ...
  'backgroundActivityFooter.dismiss': 'OK',
  'backgroundActivityFooter.dismissAll': 'Dismiss all',
  'backgroundActivityFooter.noticeCount_one': '{{count}} notice',
  'backgroundActivityFooter.noticeCount_other': '{{count}} notices',
  'backgroundActivityFooter.open': 'Open background activity',
  'backgroundActivityFooter.title': 'Background activity',
  'chromeSheet.action.close': 'Close',
  'chromeSheet.rightAside.title': 'Right panel',
  'whatsNew.dismiss': 'Got it!',
  'whatsNew.eyebrow': 'What\'s New',
  'whatsNew.history': 'Release history',
  'whatsNew.seeDetails': 'See details',
  'whatsNew.later': 'Later',
  'featureTip.eyebrow': 'Feature tip',
  'featureTip.tryIt': 'Try it',
  'aside.notes.placeholder': 'Keep session notes here…',
  'aside.notes.label': 'Notes',
  'aside.notes.saved': 'Saved',
  'aside.notes.unsaved': 'Not saved yet',
  'aside.notes.saving': 'Saving…',
  'aside.notes.error': 'Save failed',
