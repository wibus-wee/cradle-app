...
- **browser-annotation-adjustment-panel.tsx**: Right-aside Design/CSS inspector for the selected page element. Draft style edits live-preview through `applyAnnotationDesign` and commit as annotation design changes.
