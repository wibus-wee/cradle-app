...
export const workspaceWorkFixture = {
  ...
  acceptanceCriteria: ['The sidebar remains fixture-driven.'],
  linkedIssueId: null,
  handoffTitle: null,
  handoffSummary: null,
  ...
  stateSinceAt: workspaceSidebarFixtureNow - 300,
  stateExplanation: {
    trigger: 'interaction.pending',
    evidence: 'The Agent requested a user response.',
    authority: 'runtime_integration',
    responsible: 'user',
    nextAction: 'Open the Work and answer the pending request.',
    observedAt: workspaceSidebarFixtureNow,
  },
  recovery: {
    level: 'live',
    evidence: 'Chat Runtime currently owns an active run for the primary Session.',
    lastHeartbeatAt: workspaceSidebarFixtureNow - 30,
  },
  pullRequest: {
    owner: 'wibus-wee',
    repo: 'cradle-app',
