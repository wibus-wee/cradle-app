...
export function AppHeader({
  ...
  return (
    <AppHeaderView
      isDrillIn={isDrillIn}
      isTearoffWindow={isTearoffWindow}
      sidebar={{
        inSheet: sidebarInSheet,
        sheetOpen: sidebarSheetOpen,
        collapsed: sidebarCollapsed,
        toggleLabel: sidebarToggleLabel,
        collapsedWindowControlsOffset: collapsedSidebarWindowControlsOffset,
      ...
      browserPanel={!isSettingsActive && hasBrowserPanel
        ? {
            label: t('header.action.toggleBrowserPanel'),
            open: browserPanelOpen,
            onToggle: () => toggleBrowserPanel(browserPanelOwnerId),
          }
        : null}
      bottomPanel={!isSettingsActive && hasPanel
        ? {
            label: t('header.action.toggleBottomPanel'),
            open: bottomPanelOpen,
            onToggle: toggleBottomPanel,
          }
        : null}
      aside={!isSettingsActive && hasAside
        ? {
            label: t('header.action.toggleRightPanel'),
            open: asideOpen,
