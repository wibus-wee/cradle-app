...
- **route-error-view.tsx**: Props-only route failure surface for fixture-driven rendering; callers provide copy and recovery callbacks, including a copyable diagnostic handoff.
