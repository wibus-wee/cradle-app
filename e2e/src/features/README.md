...
The active suite contains 50 scenarios: 19 `@P0` smoke journeys and 31 `@P1` deeper journeys. Every scenario is tagged `@essence`, one priority, and one stable `@CRADLE-*` ID.
