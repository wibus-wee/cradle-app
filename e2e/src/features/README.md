...
The active suite contains 69 scenarios: 24 `@P0` smoke journeys and 45 `@P1` deeper journeys. Every scenario is tagged `@essence`, one priority, one runtime owner, and one stable `@CRADLE-*` ID.
